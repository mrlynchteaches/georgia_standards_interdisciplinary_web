...
const ENDPOINT_DEFINITIONS = [
  ...
  { key: 'fineArtsVisualArts', group: 'Fine Arts', label: 'Visual Arts', subjectKey: 'fineArts', subjectLabel: 'Fine Arts', courseLabel: 'Visual Arts', subdiscipline: 'Visual Arts', endpoint: 'fineArtsVisualArts.json' },
  ...
  // ctaeMiddleGrades.json does not exist
