...
const ENDPOINT_DEFINITIONS = [
  { key: 'mathematics', group: 'Core disciplines', label: 'Mathematics', subjectKey: 'mathematics', subjectLabel: 'Mathematics', endpoint: 'data/mathematics.json' },
  { key: 'science', group: 'Core disciplines', label: 'Science', subjectKey: 'science', subjectLabel: 'Science', endpoint: 'data/science.json' },
  { key: 'socialStudies', group: 'Core disciplines', label: 'Social Studies', subjectKey: 'socialStudies', subjectLabel: 'Social Studies', endpoint: 'data/socialStudies.json' },
  { key: 'ela', group: 'Core disciplines', label: 'English Language Arts', subjectKey: 'ela', subjectLabel: 'English Language Arts', endpoint: 'data/ela.json' },
  { key: 'worldLanguages', group: 'Core disciplines', label: 'World Languages', subjectKey: 'worldLanguages', subjectLabel: 'World Languages', endpoint: 'data/worldLanguages.json' },
  { key: 'fineArtsDance', group: 'Fine Arts', label: 'Dance', subjectKey: 'fineArts', subjectLabel: 'Fine Arts', courseLabel: 'Dance', subdiscipline: 'Dance', endpoint: 'data/fineArtsDance.json' },
  { key: 'fineArtsDramaticTheatre', group: 'Fine Arts', label: 'Dramatic Arts / Theatre', subjectKey: 'fineArts', subjectLabel: 'Fine Arts', courseLabel: 'Dramatic Arts / Theatre', subdiscipline: 'Dramatic Arts / Theatre', endpoint: 'data/fineArtsDramaticTheatre.json' },
  { key: 'fineArtsMusic', group: 'Fine Arts', label: 'Music', subjectKey: 'fineArts', subjectLabel: 'Fine Arts', courseLabel: 'Music', subdiscipline: 'Music', endpoint: 'data/fineArtsMusic.json' },
  { key: 'fineArtsVisualArt', group: 'Fine Arts', label: 'Visual Art', subjectKey: 'fineArts', subjectLabel: 'Fine Arts', courseLabel: 'Visual Art', subdiscipline: 'Visual Art', endpoint: 'data/fineArtsVisualArt.json' },
  { key: 'ctaeAgricultureFoodNaturalResources', group: 'CTAE clusters', label: 'Agriculture, Food, and Natural Resources', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Agriculture, Food, and Natural Resources', courseLabel: 'Agriculture, Food, and Natural Resources', endpoint: 'data/ctaeAgricultureFoodNaturalResources.json' },
  { key: 'ctaeArchitectureConstruction', group: 'CTAE clusters', label: 'Architecture and Construction', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Architecture and Construction', courseLabel: 'Architecture and Construction', endpoint: 'data/ctaeArchitectureConstruction.json' },
  { key: 'ctaeAudioVideoTechnologyCommunication', group: 'CTAE clusters', label: 'Arts, Audio-Video Technology & Communications', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Arts, Audio-Video Technology & Communications', courseLabel: 'Arts, Audio-Video Technology & Communications', endpoint: 'data/ctaeAudioVideoTechnologyCommunication.json' },
  { key: 'ctaeBusinessManagementAdministration', group: 'CTAE clusters', label: 'Business Management & Administration', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Business Management & Administration', courseLabel: 'Business Management & Administration', endpoint: 'data/ctaeBusinessManagementAdministration.json' },
  { key: 'ctaeEducationTraining', group: 'CTAE clusters', label: 'Education and Training', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Education and Training', courseLabel: 'Education and Training', endpoint: 'data/ctaeEducationTraining.json' },
  { key: 'ctaeEnergy', group: 'CTAE clusters', label: 'Energy', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Energy', courseLabel: 'Energy', endpoint: 'data/ctaeEnergy.json' },
  { key: 'ctaeFinance', group: 'CTAE clusters', label: 'Finance', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Finance', courseLabel: 'Finance', endpoint: 'data/ctaeFinance.json' },
  { key: 'ctaeGovernmentPublicAdministration', group: 'CTAE clusters', label: 'Government and Public Administration', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Government and Public Administration', courseLabel: 'Government and Public Administration', endpoint: 'data/ctaeGovernmentPublicAdministration.json' },
  { key: 'ctaeHealthScience', group: 'CTAE clusters', label: 'Health Science', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Health Science', courseLabel: 'Health Science', endpoint: 'data/ctaeHealthScience.json' },
  { key: 'ctaeHospitalityTourism', group: 'CTAE clusters', label: 'Hospitality and Tourism', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Hospitality and Tourism', courseLabel: 'Hospitality and Tourism', endpoint: 'data/ctaeHospitalityTourism.json' },
  { key: 'ctaeHumanServices', group: 'CTAE clusters', label: 'Human Services', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Human Services', courseLabel: 'Human Services', endpoint: 'data/ctaeHumanServices.json' },
  { key: 'ctaeInformationTechnology', group: 'CTAE clusters', label: 'Information Technology', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Information Technology', courseLabel: 'Information Technology', endpoint: 'data/ctaeInformationTechnology.json' },
  { key: 'ctaeLawPublicSafetyCorrectionsSecurity', group: 'CTAE clusters', label: 'Law, Public Safety, Corrections & Security', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Law, Public Safety, Corrections & Security', courseLabel: 'Law, Public Safety, Corrections & Security', endpoint: 'data/ctaeLawPublicSafetyCorrectionsSecurity.json' },
  { key: 'ctaeManufacturing', group: 'CTAE clusters', label: 'Manufacturing', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Manufacturing', courseLabel: 'Manufacturing', endpoint: 'data/ctaeManufacturing.json' },
  { key: 'ctaeMarketing', group: 'CTAE clusters', label: 'Marketing', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Marketing', courseLabel: 'Marketing', endpoint: 'data/ctaeMarketing.json' },
  { key: 'ctaeSTEM', group: 'CTAE clusters', label: 'Science, Technology, Engineering & Mathematics', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Science, Technology, Engineering & Mathematics', courseLabel: 'Science, Technology, Engineering & Mathematics', endpoint: 'data/ctaeSTEM.json' },
  { key: 'ctaeTransportationDistributionLogistics', group: 'CTAE clusters', label: 'Transportation, Distribution & Logistics', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Transportation, Distribution & Logistics', courseLabel: 'Transportation, Distribution & Logistics', endpoint: 'data/ctaeTransportationDistributionLogistics.json' },
  { key: 'ctaeWorkforceReady', group: 'CTAE clusters', label: 'Workforce Ready', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Workforce Ready', courseLabel: 'Workforce Ready', endpoint: 'data/ctaeWorkforceReady.json' },
  { key: 'ctaeMiddleGrades', group: 'CTAE clusters', label: 'Middle Grades CTAE', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Middle Grades CTAE', courseLabel: 'Middle Grades CTAE', endpoint: 'data/ctaeMiddleGrades.json' },
  { key: 'computerScience', group: 'Optional additional frameworks', label: 'Computer Science', subjectKey: 'ctae', subjectLabel: 'CTAE', cluster: 'Computer Science', courseLabel: 'Computer Science', endpoint: 'data/computerScience.json' },
  { key: 'health', group: 'Optional additional frameworks', label: 'Health', subjectKey: 'science', subjectLabel: 'Science', courseLabel: 'Health', endpoint: 'data/health.json' },
  { key: 'physicalEducation', group: 'Optional additional frameworks', label: 'Physical Education', subjectKey: 'science', subjectLabel: 'Science', courseLabel: 'Physical Education', endpoint: 'data/physicalEducation.json' }
];
...
const DEMO_STANDARDS = [
  ...
  { id: 'SCI-BIO-01', code: 'SB1', subject: 'Science', subjectKey: 'science', gradeBand: '9-12', course: 'Biology', description: 'Obtain, evaluate, and communicate information to analyze the role of matter and energy in living systems.', tags: ['matter', 'energy', 'systems', 'analysis', 'information'], skills: ['obtain', 'evaluate', 'communicate', 'analyze'] },
  { id: 'SCI-ENV-01', code: 'SES4', subject: 'Science', subjectKey: 'science', gradeBand: '9-12', course: 'Environmental Science', description: 'Analyze human impact on natural resources and use data to evaluate solutions to environmental challenges.', tags: ['human impact', 'natural resources', 'data', 'solutions', 'environment'], skills: ['analyze', 'evaluate'] },
  { id: 'SS-USH-01', code: 'SSUSH14', subject: 'Social Studies', subjectKey: 'socialStudies', gradeBand: '9-12', course: 'United States History', description: 'Analyze major political, social, and economic changes using evidence from multiple sources.', tags: ['change', 'evidence', 'multiple sources', 'social change', 'economics', 'politics'], skills: ['analyze', 'evaluate', 'compare'] },
  { id: 'ELA-WR-01', code: 'ELAGSE11-12W1', subject: 'English Language Arts', subjectKey: 'ela', gradeBand: '11-12', course: 'Argument Writing', description: 'Write arguments to support claims using valid reasoning and relevant, sufficient evidence.', tags: ['argument', 'claims', 'reasoning', 'evidence', 'writing'], skills: ['write', 'support', 'reason', 'justify'] },
  { id: 'FA-VA-01', code: 'VAHSAR.1', subject: 'Fine Arts', subjectKey: 'fineArts', gradeBand: '9-12', course: 'Visual Art', description: 'Develop artworks that communicate ideas, themes, and cultural context using critique and revision.', tags: ['ideas', 'themes', 'culture', 'communication', 'revision', 'critique'], skills: ['create', 'communicate', 'critique', 'revise'] },
